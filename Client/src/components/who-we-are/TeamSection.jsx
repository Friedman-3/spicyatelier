...
import alyImage from '../../assets/images/Content/Aly.png';
import fernandaImage from '../../assets/images/Content/Fernanda.png';
...
const TeamMemberCard = ({ name, role, isCEO = false, image }) => (
  <div className="text-center">
    ...
    <p className="text-sm text-[#641126]">{role}</p>
  </div>
);

const TeamSection = () => {
  return (
    <div className="text-[#641126] py-16 px-4 sm:px-6 lg:px-8">

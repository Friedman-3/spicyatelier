...
import alaiaHero0 from '../assets/images/Alaia/AlaiaC0.webp'
import alaiaHero1 from '../assets/images/Alaia/AlaiaTP2.webp'
import alaiaHero2 from '../assets/images/Alaia/AlaiaC1.webp'
...
const Alaia = () => {
  const productData = {
    ...
    colors: [
      { name: "Negro", code: "#86000B" },
      { name: "Plateado", code: "#EFBFBA" },
      { name: "Plateado", code: "#B0C3A7" },      
    ],
